...
-- CreateIndex
CREATE INDEX "emulator_assetId_idx" ON "emulator"("assetId");

-- CreateIndex
CREATE INDEX "emulator_userId_idx" ON "emulator"("userId");
...
-- AddForeignKey
ALTER TABLE "emulator" ADD CONSTRAINT "emulator_assetId_fkey" FOREIGN KEY ("assetId") REFERENCES "asset"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "emulator" ADD CONSTRAINT "emulator_userId_fkey" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;
