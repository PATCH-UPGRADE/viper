...
- Prefer plans that map to the linked remediations and affected device groups. Factor each device group's sorted status in: assets already confirmed unaffected do not need remediating.
