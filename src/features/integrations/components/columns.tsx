...
import { Apikey, Integration, ResourceType, SyncStatusEnum } from "@/generated/prisma";
import {
...
export const getIntegrationColumns = (resourceType: ResourceType): ColumnDef<IntegrationWithRelations>[]=> {
  return [
  {
    id: "sync",
    header: "Sync",
  ...
  },
  {
    accessorKey: "status",
    meta: { title: "Status" },
    header: ({ column }) => <SortableHeader header="Status" column={column} />,
    cell: ({ row }) => {
